...
#define XML_PUBLIC_ID_OTA_SETTINGS   {0}                    /* No XML Public ID defined */
...
typedef struct WBXMLPublicIDEntry_s
{
    ...
    const WB_TINY  xmlPublicID[60];   /**< XML Public ID */
    const WB_TINY  xmlRootElt[60];    /**< XML Root Element */
    const WB_TINY  xmlDTD[90];        /**< XML DTD */
...
{    
    const WB_TINY xmlName[50];       /**< XML Tag Name */    
...
{    
    const WB_TINY xmlNameSpace[60];  /**< XML Name Space */   
    WB_UTINY       wbxmlCodePage; /**< WBXML Code Page */
} WBXMLNameSpaceEntry;
...
{
    const WB_TINY xmlName[50];       /**< XML Attribute Name */
    const WB_TINY xmlValue[50];      /**< XML Attribute Value (may be NULL) */
    WB_UTINY       wbxmlCodePage; /**< WBXML Code Page */
...
{
    const WB_TINY xmlName[50];       /**< XML Attribute Value */
    WB_UTINY       wbxmlCodePage; /**< WBXML Code Page */
...
{
    const WB_TINY xmlName[50];    /**< XML Extension Value */
