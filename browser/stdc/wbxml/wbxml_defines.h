...
//never include stdc head file directly
...
#define WBXML_STRLEN(a)             cm_strlen((const WB_TINY*)a)
#define WBXML_STRCMP(a,b)           cm_strcmp((const WB_TINY*)a,(const WB_TINY*)b)
#define WBXML_STRNCMP(a,b,c)        cm_strncmp((const WB_TINY*)a,(const WB_TINY*)b,c)
#define WBXML_STRSTR(a,b)           cm_strstr((const WB_TINY*)a,(const WB_TINY*)b)
#define WBXML_STRRCHR(a,b)          cm_strrchr((const WB_TINY*)a,(S32)b)
#define WBXML_STRCASECMP(a,b)       cm_strcasecmp((const WB_TINY*)a,(const WB_TINY*)b)
#define WBXML_STRNCASECMP(a,b,c)    cm_strncasecmp((const WB_TINY*)a,(const WB_TINY*)b,c)

#define WBXML_SPRINTF               cm_sprintf
